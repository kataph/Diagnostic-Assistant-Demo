"""
DiagnosticAssistantFixedRandomTrajectories — mock diagnostic assistant for protocol testing.
...
class DiagnosticAssistantFixedRandomTrajectories(DiagnosticAssistant):
    """
